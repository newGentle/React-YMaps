...
import { Stack, Toast, Form, Table } from "react-bootstrap";
        ...
        <Toast style={{width: '100%'}}>
          ...
          <Toast.Body>
            ...
            <Table>
              ...
              <tbody>
                <tr>
                  <td>{getTime(weather[0].daily[0].sunrise)}</td>
                  <td>{getTime(weather[0].daily[0].sunset)}</td>
                  <td>{weather[0].daily[0].temp.morn} &#8451;</td>
                  <td>{weather[0].daily[0].temp.day} &#8451;</td>
                  <td>{weather[0].daily[0].temp.eve} &#8451;</td>
                  <td>{weather[0].daily[0].temp.night} &#8451;</td>
                  <td>{weather[0].daily[0].wind_speed} м/сек.</td>
                  <td>              <img
                src={`https://openweathermap.org/img/wn/${weather[0].daily[0].weather[0].icon}@2x.png`}
                alt=""
              />
              <p>{weather[0].daily[0].weather[0].description}</p>
              </td>
                </tr>
              </tbody>
            </Table>
